...
// CourseProject.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CCourseProjectApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CCourseProjectApp::OnAppAbout)
...
// Создание CCourseProjectApp

CCourseProjectApp::CCourseProjectApp() noexcept
{
	...
	SetAppID(_T("CourseProject.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CCourseProjectApp

CCourseProjectApp theApp;


// Инициализация CCourseProjectApp

BOOL CCourseProjectApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CCourseProjectDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CCourseProjectView));
	if (!pDocTemplate)
		return FALSE;
...
int CCourseProjectApp::ExitInstance()
{
...
// Обработчики сообщений CCourseProjectApp
...
void CCourseProjectApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
